    ...
    <Box sx={{ p: 5, backgroundColor: "#f9fafc", minHeight: "100vh" }}>
      ...
      >
        <Grid item xs={12} sm={6} md={2}>
          <Card sx={{ borderLeft: "5px solid #1976d2", height: "100%",width: "190px" }}>
            <CardContent>
              <Typography variant="subtitle2" color="text.secondary">
                Total Revenue
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Card sx={{ borderLeft: "5px solid #2e7d32", height: "100%",width:"190" }}>
            <CardContent>
              <Typography variant="subtitle2" color="text.secondary">
                Total Sales
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Card sx={{ borderLeft: "5px solid #ed6c02", height: "100%",ml:2 }}>
            <CardContent>
              <Typography variant="subtitle2" color="text.secondary">
                Total Employees
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Card sx={{ borderLeft: "5px solid #6a1b9a", height: "100%" }}>
            <CardContent>
              <Typography variant="subtitle2" color="text.secondary">
                Teams
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Card sx={{ borderLeft: "5px solid #0288d1", height: "100%" }}>
            <CardContent>
              <Typography variant="subtitle2" color="text.secondary">
                Avg Revenue / Sale
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <Card sx={{ borderLeft: "5px solid #c62828", height: "100%" }}>
            <CardContent>
              <Typography variant="subtitle2" color="text.secondary">
                Top Performing Team
              </Typography>
